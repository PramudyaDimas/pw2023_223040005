               ...
               <div class="col-md-4">
                  <div class="card-box h-100">
                     <div class="card-header">
                        <h2 class="card-title mb-2">Welcome pramudya</h2>
                        <span class="d-block mb-4 text-nowrap">Mahasiswa Unpas</span>
                     </div>
                     <br><br>
                     ...
                     <div class="card-body">
                        <div class="row ">
                           <div class="col-md-6">
                              <h1 class="display-6 text-primary mb-2 pt-4 pb-1">Newbie</h1>
                              <small class="d-block mb-3">In <br>PHP, HTML, CSS</small>
                              <br>
                              <br>
